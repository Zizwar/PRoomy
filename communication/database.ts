    ...
    */
    ...
    await sql`
      create table if not exists rooms (
        ...
        constraint rooms_by_fkey foreign key (by) references users (id)
      )`;
    await sql`
      create table if not exists messages (
        ...
        from
          ...
          constraint messages_from_fkey foreign key ("from") references users (id),
          constraint messages_room_fkey foreign key (room) references rooms (id),
          constraint messages_to_fkey foreign key ("to") references users (id)
      )`;
    await sql`
